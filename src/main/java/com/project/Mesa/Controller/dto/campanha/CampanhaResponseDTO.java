...
public record CampanhaResponseDTO(Long id, String periodo, String grupo,Filial empresa, String categoria_participante,
	...
	public static CampanhaResponseDTO fromCampanhaResponseDTO(Campanha campanha) {
		return new CampanhaResponseDTO(campanha.getId(), campanha.getPeriodo(), campanha.getGrupo(), campanha.getEmpresa(),
