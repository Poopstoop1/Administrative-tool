...
public record CampanhaResponseDTO(Long id, String periodo, String grupo, String cnpj, String categoria_participante,
	...
	public static CampanhaResponseDTO fromCampanhaResponseDTO(Campanha campanha) {
		return new CampanhaResponseDTO(campanha.getId(), campanha.getPeriodo(), campanha.getGrupo(), campanha.getEmpresa().getCnpj(),
				...
				campanha.getValor_com_taxa(), campanha.getColocacao(), campanha.getPositivou(), campanha.getPagina());
	}
